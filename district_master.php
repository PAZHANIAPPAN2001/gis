...
<body>
    <center><br><br>
    <center><h1>District Masters</h1></center>
    <form>
    ...
    <!-- <select name="select" id="select" onchange='state()'>
        ...
        <div id="popup-form">
        <form name="createstate" action="district_other.php" method="post">
           STATE NAME:<input type="text" name="state"><br><br>
           District Name:<input type="text" name="district"><br><br>
          <!-- Taluk Name:<input type="text" name="taluk"><br><br><br>-->
        <input type="submit" name="create" value="Create">
</form>
        </div>
</script>
<div id="delete-form" onsubmit="return openform1()">
  <form name="deletestate" action="district_delete.php" method="post">
    STATE Name:<input type="text" name="state"><br><br>
    District Name:<input type="text" name="district"><br><br>
  <!--  Taluk Name:<input type="text" name="taluk"><br>-->
<br>
    <input type="submit" name="delete" value="Delete">
</form>
      </div>
           <div class="update" id="modify-form" onsubmit="return openForm()">
           <form method="post" action="district_other.php">
          ...
          <input type="text" name="taluk" id="taluk" required><br>-->
